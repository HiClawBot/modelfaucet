...
> Status: MVP implementation. The local stack includes the Control API, Gateway, Dashboard, SDK, React package, CRM demo, Local Bridge, wallet credits, Stripe test-mode top-ups, and payout mock.
