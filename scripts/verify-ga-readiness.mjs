...
try {
  assert(packageJson.version === "1.0.0", "package.json version must be 1.0.0.");
  ...
  assertIncludes("README.md", ["Status: `1.0.0` source GA", "stable public contracts"]);
  assertIncludes("README.zh-CN.md", ["状态：`1.0.0` source GA", "稳定公共契约"]);
  assertIncludes("CHANGELOG.md", ["## 1.0.0 - 2026-06-18", "General availability"]);
